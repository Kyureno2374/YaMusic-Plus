...
(async () => {
    ...
    const window = await (0, createWindow_js_1.createWindow)();
      ...
      session.defaultSession.webRequest.onBeforeRequest(
        { urls: ["https://yandex.ru/clck/*","https://mc.yandex.ru/*","https://api.music.yandex.net/dynamic-pages/trigger/*","https://log.strm.yandex.ru/*","https://api.acquisition-gwe.plus.yandex.net/*","https://api.events.plus.yandex.net/*","https://events.plus.yandex.net/*","https://plus.yandex.net/*","https://yandex.ru/ads/*","https://strm.yandex.ru/ping"] },
        (details, callback) => {
...
(async () => { // YaMusic Plus - Main Mod Entry Point
console.log('YaMusic Plus загружен!');

// Здесь будет основная логика мода
